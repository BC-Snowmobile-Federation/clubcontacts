...
//                         <dt className="text-gray-500">Club Mailing Address</dt>
//                         {editingClub === club[0] ? (
//                           <input
...
//                       </div>
//                       <div className="flex justify-between gap-x-4 py-3">
//                         <dt className="text-gray-500">Club Mailing Town</dt>
//                         {editingClub === club[0] ? (
//                           <input
//                             className="border text-sm rounded-full w-[180px] p-1"
//                             onChange={(e) =>
...
//                       </div>
//                       <div className="flex justify-between gap-x-4 py-3">
//                         <dt className="text-gray-500">Club Mailing Province</dt>
//                         {editingClub === club[0] ? (
//                           <input
//                             className="border text-sm rounded-full w-[180px] p-1"
//                             onChange={(e) =>
...
//                             className="border text-sm rounded-full w-[180px] p-1"
//                             onChange={(e) =>
//                               handleInputChange("Club Website", e.target.value)
//                             }
//                             defaultValue={club[5]}
//                           />
//                         ) : (
...
//                             className="border text-sm rounded-full w-[180px] p-1"
//                             onChange={(e) =>
//                               handleInputChange("Club Facebook", e.target.value)
//                             }
...
//                             className="border text-sm rounded-full w-[180px] p-1"
//                             onChange={(e) =>
//                               handleInputChange("Club Tik Tok", e.target.value)
//                             }
...
//                 ))
//               ) : (
//                 <li className="overflow-hidden montserrat rounded-xl border border-gray-200 w-[26rem]">
//                   <div className="flex items-center gap-x-4 border-b border-gray-900/5 bg-gray-50 p-6">
//                     <div className="text-base font-semibold leading-6 text-[#243746]">
//                       {initialClubName}
//                     </div>
...
//                                 className="font-semibold text-base text-[#535787] cursor-pointer bg-transparent"
//                                 onClick={() =>
//                                   handleSaveChanges(initialClubName)
//                                 }
//                               >
//                                 Save
//                                 <span className="sr-only">
...
//                             <button
//                               type="button"
//                               onClick={() => handleOpenMenu(initialClubName)}
//                               className="menu-button -m-2.5 block p-2.5 text-gray-400 hover:text-gray-500"
//                               id={`options-menu-${initialClubName}-button`}
//                               aria-expanded="false"
//                               aria-haspopup="true"
//                             >
//                               <span className="sr-only">Open options</span>
...
//                             </button>
//                             {menuVisible &&
//                               initialClubName === clubMenuOpen && (
//                                 <div
//                                   className="dropdown-menu absolute right-0 z-10 mt-0.5 w-32 origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none"
//                                   role="menu"
//                                   aria-orientation="vertical"
//                                   aria-labelledby={`options-menu-${initialClubName}-button`}
//                                   tabIndex="-1"
//                                 >
//                                   {isLoadingPost || isLoadingEditClub ? (
//                                     <div
...
//                                           role="menuitem"
//                                           onClick={() =>
//                                             handleDeleteClub(initialClubName)
//                                           }
//                                           tabIndex="-1"
//                                           id={`options-menu-${initialClubName}-item-1`}
//                                         >
//                                           Delete
//                                           <span className="sr-only">
//                                             , {initialClubName}
...
//                                         role="menuitem"
//                                         onClick={() =>
//                                           handleEditClick(initialClubName)
//                                         }
//                                         tabIndex="-1"
//                                         id={`options-menu-${initialClubName}-item-2`}
//                                       >
//                                         Edit
//                                         <span className="sr-only">
//                                           , {initialClubName}
...
//                           className="border text-sm rounded-full w-[180px] p-1"
//                           onChange={(e) =>
//                             handleInputChange("Club Main Phone", e.target.value)
//                           }
//                         />
//                       ) : (
//                         <dd className="flex items-start gap-x-2">
...
//                     </div>
//                     <div className="flex justify-between gap-x-4 py-3">
//                       <dt className="text-gray-500">Club BC Society Number</dt>
//                       {editingClub === initialClubName ? (
//                         <input
//                           className="border text-sm rounded-full w-[180px] p-1"
//                           onChange={(e) =>
...
//                     </div>
//                     <div className="flex justify-between gap-x-4 py-3">
//                       <dt className="text-gray-500">Financial Year End Date</dt>
//                       {editingClub === initialClubName ? (
//                         <input
//                           className="border text-sm rounded-full w-[180px] p-1"
//                           onChange={(e) =>
...
//                           className="border text-sm rounded-full w-[180px] p-1"
//                           onChange={(e) =>
//                             handleInputChange("Club GST Number", e.target.value)
//                           }
//                         />
//                       ) : (
//                         <dd className="flex items-start gap-x-2">
...
//                           className="border text-sm rounded-full w-[180px] p-1"
//                           onChange={(e) =>
//                             handleInputChange("Club PST Number", e.target.value)
//                           }
//                         />
//                       ) : (
//                         <dd className="flex items-start gap-x-2">
...
//                           className="border text-sm rounded-full w-[180px] p-1"
//                           onChange={(e) =>
//                             handleInputChange("Club Instagram", e.target.value)
//                           }
//                         />
//                       ) : (
//                         <dd className="flex items-start gap-x-2">
